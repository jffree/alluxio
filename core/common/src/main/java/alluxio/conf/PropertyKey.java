...
public final class PropertyKey implements Comparable<PropertyKey> {
  ...
  public static final PropertyKey MASTER_FILE_SYSTEM_LISTSTATUS_RESULTS_PER_MESSAGE =
      new Builder(Name.MASTER_FILE_SYSTEM_LISTSTATUS_RESULTS_PER_MESSAGE)
          ...
          .setScope(Scope.MASTER)
          .build();
  public static final PropertyKey MASTER_FILE_SYSTEM_RETRY_CACHE_ENABLED =
      new Builder(Name.MASTER_FILE_SYSTEM_RETRY_CACHE_ENABLED)
          .setDefaultValue(true)
          .setDescription("If enabled, each fs operation will be tracked on master, "
              + "in order to avoid re-execution on client retry.")
          .setConsistencyCheckLevel(ConsistencyCheckLevel.WARN)
          .setScope(Scope.MASTER)
          .build();
  public static final PropertyKey MASTER_FILE_SYSTEM_RETRY_CACHE_SIZE =
      new Builder(Name.MASTER_FILE_SYSTEM_RETRY_CACHE_SIZE)
          .setDefaultValue(10000)
  ...
  public static final PropertyKey USER_FILE_INCLUDE_OPERATION_ID =
      new Builder(Name.USER_FILE_INCLUDE_OPERATION_ID)
          .setDefaultValue(true)
          .setDescription("Whether to send a unique operation id with each FS call.")
          .setConsistencyCheckLevel(ConsistencyCheckLevel.WARN)
          .setScope(Scope.CLIENT)
          .build();
  ...
  public static final class Name {
    ...
    public static final String MASTER_FILE_SYSTEM_RETRY_CACHE_ENABLED =
        "alluxio.master.filesystem.retry.cache.enabled";
    public static final String MASTER_FILE_SYSTEM_RETRY_CACHE_SIZE =
        "alluxio.master.filesystem.retry.cache.size";
